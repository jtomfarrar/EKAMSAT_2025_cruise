...
The following topics will be covered in this readme file:
  ...
  1. Sea Level Barometric Pressure
  2. Time Stamp
...
Sea Level Pressure first became available in the TAO/TRITON 
array in March 1998 at TRITON sites along 156E longitude. 
Sea Level Pressure is available in the Pacific, Atlantic,
and Indian oceans. Sea level pressure has units of hPa 
(hectoPascals).

ATLAS buoys measure pressure from a height of 3 m above
mean sea level, while TRITON buoys measure it at 2 m 
above sea level. (Instrument height in the data files is 
shown as a negative depth).
